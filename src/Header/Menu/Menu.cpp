...
QtwmFMMainMenu::QtwmFMMainMenu(QWidget *parent)
	: QMenu(parent), MountingSubMenu(new QMenu(this)),
	  ViewSubMenu(new QMenu(this)), SettingsSubMenu(new QMenu(this)),
	...
	MountingSubMenu->addAction("Mount / Umount");
	MountingSubMenu->addAction("Network Devices");
